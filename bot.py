...
async def trivia(ctx):
    ...
    with open('TNG.csv', encoding="utf-8") as questions:
...
@bot.command(name="get", help="View current player Stats.", category="STA")
async def getStat(ctx):
    await player_embed(ctx)

@bot.command(name="set", help="sets various player stats.")
